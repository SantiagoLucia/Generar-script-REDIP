...
def crear_scripts_sql(df):
    ...
    with engine.connect() as conn:
        ...
        query = sqlalchemy.text("""SELECT ID_CIRCUNSCRIPCION FROM 
        ...
        query = sqlalchemy.text("""SELECT ID_KODAK_CIRCUNSCRIPCION FROM RCE_GED.SYS_KODAK_CIRCUNSCRIPCION 
        ...
        for _, row in df.iterrows():
            ...
            try:
                ...
                query = sqlalchemy.text(f"""SELECT LOC.ID
